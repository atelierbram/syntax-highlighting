#!/usr/bin/env bash
# Base16 Duotone-DarkSea - Gnome Terminal color scheme install script
...
gset string palette "#ebf4ff:#52a3ff:#708f85:#3bce9d:#54d4a9:#85beff:#68d9b4:#91c1f8:#6e88a6:#52a3ff:#708f85:#3bce9d:#54d4a9:#85beff:#68d9b4:#1d262f"
gset string background_color "#ebf4ff"
gset string foreground_color "#556e8b"
gset string bold_color "#556e8b"
