...
gset string palette "#1d262f:#52a3ff:#708f85:#3bce9d:#54d4a9:#85beff:#68d9b4:#91c1f8:#6e88a6:#52a3ff:#708f85:#3bce9d:#54d4a9:#85beff:#68d9b4:#ebf4ff"
gset string background_color "#1d262f"
gset string foreground_color "#91c1f8"
gset string bold_color "#91c1f8"
