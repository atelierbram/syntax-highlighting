#!/usr/bin/env bash
# Base16 Duotone-DarkSpace - Gnome Terminal color scheme install script
...
gset string palette "#ebebff:#6c6ccb:#94796b:#e67841:#ee8753:#9999d1:#f49666:#8888fb:#767693:#6c6ccb:#94796b:#e67841:#ee8753:#9999d1:#f49666:#24242e"
gset string background_color "#ebebff"
gset string foreground_color "#58586f"
gset string bold_color "#58586f"
