...
color_foreground="78/dd/78" # Base 05
color_background="2a/2d/2a" # Base 00
color_cursor="78/dd/78" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 78dd78 # forground
  printf $printf_template_custom Ph 2a2d2a # background
  printf $printf_template_custom Pi 78dd78 # bold color
  printf $printf_template_custom Pj 556855 # selection color
  printf $printf_template_custom Pk 78dd78 # selected text color
  printf $printf_template_custom Pl 78dd78 # cursor
  printf $printf_template_custom Pm 2a2d2a # cursor text
else
