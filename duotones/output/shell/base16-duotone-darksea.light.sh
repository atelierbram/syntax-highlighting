...
color_foreground="55/6e/8b" # Base 02
color_background="eb/f4/ff" # Base 07
color_cursor="55/6e/8b" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 556e8b # forground
  printf $printf_template_custom Ph ebf4ff # background
  printf $printf_template_custom Pi 556e8b # bold color
  printf $printf_template_custom Pj 91c1f8 # selection color
  printf $printf_template_custom Pk 556e8b # selected text color
  printf $printf_template_custom Pl 556e8b # cursor
  printf $printf_template_custom Pm ebf4ff # cursor text
else
