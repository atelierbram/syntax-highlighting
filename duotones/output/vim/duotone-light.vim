" Duotone-Light (https://github.com/chriskempson/base16)
" Scheme: adapted from: Simurai (https://github.com/simurai/duotone-light-syntax/)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/duotone-light.".&background.".sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "duotone-light"
