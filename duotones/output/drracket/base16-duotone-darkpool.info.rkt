...
;; color scheme
(define base00 #(30 29 32))
(define base01 #(55 52 60))
(define base02 #(79 75 88))
(define base03 #(104 97 117))
(define base04 #(128 119 146))
(define base05 #(165 126 241))
(define base06 #(212 194 250))
(define base07 #(245 240 254))
(define base08 #(127 91 200))
(define base09 #(180 110 60))
(define base0A #(200 121 65))
(define base0B #(178 140 112))
(define base0C #(221 148 95))
(define base0D #(211 134 80))
(define base0E #(160 137 205))
(define base0F #(144 114 202))

(define framework:color-schemes
  `(#hash((name . "Base16 Duotone-DarkPool Dark")
    ...
    #hash((name . "Base16 Duotone-DarkPool Light")
