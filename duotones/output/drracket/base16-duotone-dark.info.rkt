...
(define base01 #(66 63 80))
(define base02 #(90 86 108))
(define base03 #(114 110 135))
(define base04 #(131 123 173))
(define base05 #(155 135 253))
(define base06 #(196 184 254))
(define base07 #(238 235 255))
(define base08 #(119 101 210))
(define base09 #(192 120 48))
(define base0A #(212 133 53))
(define base0B #(150 143 136))
(define base0C #(232 163 94))
(define base0D #(222 145 69))
(define base0E #(164 155 207))
(define base0F #(142 129 207))
