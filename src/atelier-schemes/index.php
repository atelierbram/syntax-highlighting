...
<article class="article article--demo">
    ...
    <p>More about the thought process behind some of the <a href="demo/changes-03-2015.html">documented updates and changes</a> made halfway during the time of creation.</p>

    <h3 id="forest"><a href="<?= $rootUrl; ?><?= $page; ?>/forest">Forest</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?><?= $page; ?>/forest/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="plateau" class="mtm"><a href="<?= $rootUrl; ?><?= $page; ?>/plateau">Plateau</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?><?= $page; ?>/plateau/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="heath" class="mtm"><a href="<?= $rootUrl; ?><?= $page; ?>/heath">Heath</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?><?= $page; ?>/heath/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="cave" class="mtm"><a href="<?= $rootUrl; ?><?= $page; ?>/cave">Cave</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?><?= $page; ?>/cave/">information</a> on code, color-values and more &hellip;.</p>


    <h3 id="sulphurpool" class="mtm"><a href="<?= $rootUrl; ?><?= $page; ?>/sulphurpool">Sulphurpool</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?><?= $page; ?>/sulphurpool/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="lakeside" class="mtm"><a href="<?= $rootUrl; ?><?= $page; ?>/lakeside">Lakeside</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?><?= $page; ?>/lakeside/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="savanna" class="mtm"><a href="<?= $rootUrl; ?><?= $page; ?>/savanna">Savanna</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?><?= $page; ?>/savanna/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="seaside" class="mtm"><a href="<?= $rootUrl; ?><?= $page; ?>/seaside">Seaside</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?><?= $page; ?>/seaside/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="estuary" class="mtm"><a href="<?= $rootUrl; ?><?= $page; ?>/estuary">Estuary</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?><?= $page; ?>/estuary/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="dune" class="mtm"><a href="<?= $rootUrl; ?><?= $page; ?>/dune">Dune</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?><?= $page; ?>/dune">information</a> on code, color-values and more &hellip;.</p>
