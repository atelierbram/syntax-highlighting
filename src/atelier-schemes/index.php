...
<article class="article article--demo">
    ...
    <h3 id="forest"><a href="<?= $rootUrl; ?>/forest">Forest</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?>/forest/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="plateau" class="mtm"><a href="<?= $rootUrl; ?>/plateau">Plateau</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?>/plateau/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="heath" class="mtm"><a href="<?= $rootUrl; ?>/heath">Heath</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?>/heath/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="cave" class="mtm"><a href="<?= $rootUrl; ?>/cave">Cave</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?>/cave/">information</a> on code, color-values and more &hellip;.</p>


    <h3 id="sulphurpool" class="mtm"><a href="<?= $rootUrl; ?>/sulphurpool">Sulphurpool</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?>/sulphurpool/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="lakeside" class="mtm"><a href="<?= $rootUrl; ?>/lakeside">Lakeside</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?>/lakeside/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="savanna" class="mtm"><a href="<?= $rootUrl; ?>/savanna">Savanna</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?>/savanna/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="seaside" class="mtm"><a href="<?= $rootUrl; ?>/seaside">Seaside</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?>/seaside/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="estuary" class="mtm"><a href="<?= $rootUrl; ?>/estuary">Estuary</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?>/estuary/">information</a> on code, color-values and more &hellip;.</p>

    <h3 id="dune" class="mtm"><a href="<?= $rootUrl; ?>/dune">Dune</a></h3>
    ...
    <p>More <a href="<?= $rootUrl; ?>/dune">information</a> on code, color-values and more &hellip;.</p>
