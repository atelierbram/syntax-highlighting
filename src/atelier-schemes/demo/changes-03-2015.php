...
<article class="article article--demo">
  <!-- <div id="wrap" class="inner&#45;wrap"> -->
    ...
    <p>Besides documenting my learning curve, another reason for these explanations is to give insight in the changes to third parties, who are already using these colorschemes.</p>

    <h3 class="bn" id="forest"><a href="../forest">Forest</a></h3>
...
<span style="color:#f22c40">string</span> = <span style="color:#5ab738">"base16"</span>
    ...
    <p class="mtm clear"><strong>After</strong></p>
...
<![CDATA[
    ...
    <p class="mtm clear"><strong>Before</strong></p>
    <pre class="base16" style="background-color:#1b181b;color:#ab9bab"><span style="color:#7b59c0">
...
<span style="color:#ca402b">string</span> = <span style="color:#379a37">"base16"</span>
    ...
    <pre class="base16" style="background-color:#1b1918;color:#ab9bab"><span style="color:#7b59c0">
...
<![CDATA[
    ...
    <p class="mtm clear"><strong>Before</strong></p>
    <pre class="base16" style="background-color:#161b1d;color:#7ea2b4"><span style="color:#5d5db1">
...
<span style="color:#d22d72">string</span> = <span style="color:#568c3b">"base16"</span>
    ...
    <pre class="base16" style="background-color:#161b1d;color:#7ea2b4"><span style="color:#6b6bb8">
require</span> <span style="color:#568c3b">"gem"</span>
<span style="color:#d22d72">string</span> = <span style="color:#568c3b">"base16"</span>
...
<![CDATA[
    ...
    <pre class="base16" style="background-color:#f0fff0;color:#5e6e5e"><span style="color:#e6193c">
...
<![CDATA[
    ...
    <pre class="base16" style="background-color:#fefbec;color:#6e6b5e"><span style="color:#d73737">
...
<span style="color:#6684e1">print</span> <span style="color:#ae9513">Person</span>::<span style="color:#6684e1">greet</span>, <span style="color:#60ac39">" "</span>, <span style="color:#d73737">person1</span>.<span style="color:#6684e1">name</span>, <span style="color:#60ac39">"<span style="color:#b65611">\n</span>"</span></pre>
    ...
    <h3 id="downloads" class="mtm bn">Downloads</h3>
    ...
    <p class="note">
    Note: For Sublime Text, go to <a href="https://github.com/atelierbram/syntax-highlighting/tree/master/atelier-schemes/output/textmate">Textmate folder</a>.</p>
...
git clone https<span class="token punctuation">:</span><span style="color:#935c25">/</span><span class="token operator" style="color:#935c25">/</span>github<span class="token punctuation">.</span>com<span style="color:#935c25">/</span>atelierbram<span style="color:#935c25">/</span>vim<span style="color:#935c25">-</span>colors_atelier<span style="color:#935c25">-</span>schemes<span class="token punctuation">.</span>git
    ...
    <h3 id="demo" class="mtm bn">Demo</h3>
    <ul>
    ...
    <h3 id="credits" class="mtm bn">Credits</h3>
