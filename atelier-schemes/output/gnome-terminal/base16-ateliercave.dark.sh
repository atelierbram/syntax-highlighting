...
gset string palette "#302046:#cf598a:#74875a:#a08f3b:#6577d2:#955ae7:#328fae:#9b8eaf:#6e588d:#cf598a:#74875a:#a08f3b:#6577d2:#955ae7:#328fae:#f4f0fa"
gset string background_color "#302046"
gset string foreground_color "#9b8eaf"
gset string bold_color "#9b8eaf"
