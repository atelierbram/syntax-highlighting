...
;; color scheme
(define base00 #(21 40 28))
(define base01 #(29 52 37))
(define base02 #(65 98 76))
(define base03 #(79 114 91))
(define base04 #(104 141 116))
(define base05 #(115 156 128))
(define base06 #(191 217 200))
(define base07 #(221 238 227))
