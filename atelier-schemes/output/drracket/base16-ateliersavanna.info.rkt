...
;; color scheme
(define base00 #(26 35 29))
(define base01 #(36 46 39))
(define base02 #(78 101 85))
(define base03 #(90 114 98))
(define base04 #(115 140 123))
(define base05 #(128 153 136))
(define base06 #(217 232 222))
(define base07 #(232 247 237))
