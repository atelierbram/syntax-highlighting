-- Atelier Sulpherpool theme for Textadept (http://foicica.com/textadept/)
-- Theme author: Bram de Haan (http://atelierbram.github.io/syntax-highlighting/atelier-schemes/sulperpool)
